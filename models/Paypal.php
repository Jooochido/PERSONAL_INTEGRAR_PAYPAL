<?php
    ...
    class Paypal extends Conectar{
        ...
        public function get_paypal($arrayDetalle,$vent_total,$vent_id){
            ...
            $redirectUrls->setReturnUrl("http://localhost:8080/PERSONAL_INTEGRAR_PAYPAL/view/Invoice/?vent_id=".$vent_id)
                        ->setCancelUrl("http://localhost:8080/PERSONAL_INTEGRAR_PAYPAL/view/Cart");
        ...
        public function get_validar_paypal($paymentId, $PayerID){
            require '../include/bootstrap.php';
            ...
            $datosTransacion=$payment->toJSON();

            return $datosTransacion;
        }
