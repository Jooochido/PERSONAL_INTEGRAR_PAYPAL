                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                                                ...
                                                <ul class="mega-menu clothing-menu">
                                                    <li>
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img src="../../public/images/mega-menu/fashion.jpg" alt="" class="img-fluid blur-up lazyload"></a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                            ...
                            <div class="brand-logo">
                                <a href="index.html"> <img src="../../public/images/icon/logo.png" class="img-fluid blur-up lazyload" alt=""></a>
                            </div>
                        </div>
                                            ...
                                            <ul class="mega-menu full-mega-menu">
                                                <li>
                                                    <div class="container">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <img src="../../public/images/menu-banner.jpg" class="img-fluid mega-img">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                ...
                                <div class="icon-nav">
                                    <ul>
                                        <li class="onhover-div mobile-search">
                                            <div><img src="../../public/images/icon/search.png" onclick="openSearch()" class="img-fluid blur-up lazyload" alt="">
                                        ...
                                        <li class="onhover-div mobile-setting">
                                            <div><img src="../../public/images/icon/setting.png" class="img-fluid blur-up lazyload" alt="">
                                        ...
                                        <li class="onhover-div mobile-cart">
                                            <div><img src="../../public/images/icon/cart.png" class="img-fluid blur-up lazyload" alt="">
                                                <i class="ti-shopping-cart"></i>
                                            </div>
                                            <ul class="show-div shopping-cart">
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img class="me-3" src="../../public/images/fashion/product/1.jpg" alt="Generic placeholder image"></a>
                                                ...
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img class="me-3" src="../../public/images/fashion/product/2.jpg" alt="Generic placeholder image"></a>
                                                        <div class="media-body">
                                                            <a href="#">
                                                                <h4>item name</h4>
                                                            </a>
